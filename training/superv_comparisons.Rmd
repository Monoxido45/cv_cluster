...
display.superv_comp = function(data, clust.list, test_index, dist = NA){
  ...
  cat("Score versus proportion of hits: ", cor(data.test$V3, data.test$V1), "\n")
  cat("Score versus F1: ", cor(data.test$V3, data.test$V2), "\n")
  cat("Score versus FOM: ", cor(data.test$V3, data.test$FOM), "\n")
  
  show(g4)
  show(g5)
  cat("Correlations between FOM and other variables: \n")
  cat("FOM versus F1: ", cor(data.test$FOM, data.test$V2), "\n")
  cat("FOM versus proportion of hits: ", cor(data.test$FOM, data.test$V1), "\n")
}
